...
public class MetodLaplasa {

    public static int[][][] laplacianEdgeDetection(int[][][] image) {
    ...
    public static void metodLaplasa() throws IOException {
        ...
        ImageIO.write(output, "JPEG", new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\MetodLaplasa.jpg"));
    }
}
