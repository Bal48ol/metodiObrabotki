...
public class OperatorPrevita {
    ...
    public static void operatorPrevita() {
        try {
            ...
            File outputFile = new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\OperatorPrevita.jpg");
    ...
    public static BufferedImage prewittOperator(BufferedImage image) {
