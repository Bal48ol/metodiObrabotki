...
public class LowHighPassFilter {
    public static void lowPassFilter() {
        try {
            ...
            String outputImagePath = "C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\LowPassFilter.jpg";
    ...
    public static void highPassFilter() {
        try {
            ...
            // Сохранение отфильтрованного изображения
            String outputImagePath = "C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\HighPassFilter.jpg";
            File outputFile = new File(outputImagePath);
            ImageIO.write(filteredImage, "jpg", outputFile);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static BufferedImage applyFilter(BufferedImage image, double[][] kernel) {
