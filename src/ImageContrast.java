...
public class ImageContrast {
    public static void imageContrast() {
        try {
            ...
            File output = new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\img_contrast_high.jpg");
            ...
            // Сохраняем измененный файл изображения
            output = new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\img_contrast_low.jpg");
            ImageIO.write(image, "jpg", output);
        } catch (Exception e) {
