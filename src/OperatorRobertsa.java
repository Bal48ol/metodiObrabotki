...
public class OperatorRobertsa {

    public static void operatorRobertsa() {
        try {

            BufferedImage inputImage = ImageIO.read(new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\котяк.png"));

            // добавляем оператор Робертса в изображение
            BufferedImage outputImage = robertsOperator(inputImage);


            File outputFile = new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\OperatorRobertsa.jpg");
    ...
    public static BufferedImage robertsOperator(BufferedImage image) {
