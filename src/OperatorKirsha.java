...
public class OperatorKirsha {

    public static void operatorKirsha() {
        ...
        try {
            ...
            File output = new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\OperatorKirsha.jpg");
    ...
    private static BufferedImage applyKernel(BufferedImage image, int[][] kernel) {
