...
public class OperatorSobely  {

    public static void operatorSobely () {
        try {
            ...
            File outputFile = new File("C:\\Users\\dayof\\IdeaProjects\\metodiObrabotki\\img\\OperatorSobely.jpg");
    ...
    public static BufferedImage sobelOperator(BufferedImage image) {
